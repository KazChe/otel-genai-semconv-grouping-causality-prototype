"""Baseline ReAct agent — standard OTEL instrumentation, NO grouping, NO causality.

This is the 'before' state. Run this, then look at the trace in Aspire/Galileo.
You'll see a flat list of spans with no signal for which round they belong to
or which LLM call triggered which tool execution.
"""
...
tracer = trace.get_tracer("baseline-demo")
...
async def main():
    ...
    provider.shutdown()
    print("[tracing] Spans flushed. Check Aspire at http://localhost:18888 - baseline-demo")
